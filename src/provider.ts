...
async function* streamChat(
  ...
  try {
    ...
    // Workaround: fetchStream returns AsyncIterable<string> but the underlying
    // Response object may contain HTTP status info. We cast to access .ok/.status
    // for error detection. This should be replaced when extension-api exposes
    // HTTP status on stream responses.
